...
be preparing to blast a hole in the ocean floor; sensors indicate
a massive underground cave system just beyond where they're aiming!

The crab submarines all need to be aligned before they'll have
enough power to blast a large enough hole for your submarine to
get through. However, it doesn't look like they'll be aligned
...
align them all on, but the one that costs the least fuel
...
if __name__ == "__main__":
    ...
    min_pos, min_fuel = find_minimum_fuel_spent(initial_positions)
