...
is marked on all boards on which it appears. (Numbers may not
appear on all boards.) If all numbers in any row or any column
of a board are marked, that board wins. (Diagonals don't count.)
...
from day4.part1._read_data import read_test_data
from day4.part1.bingo_game import BingoGame

if __name__ == "__main__":
    boards, numbers_to_draw = read_day4_data()
    game = BingoGame(boards, numbers_to_draw)
